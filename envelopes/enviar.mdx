...
description: Cria e envia um envelope para assinatura com documento PDF em formato base64.
openapi: 'POST /api/envelopes/send/base64'
---

Este endpoint permite criar e enviar envelopes enviando o PDF diretamente codificado em base64, eliminando a necessidade de fazer upload para S3 previamente. O envelope é enviado automaticamente para os destinatários após a criação.
